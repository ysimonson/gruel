...
<!-- ADR-0087 Phase 3 moved the line-reading, integer-parsing, and
     random-number-generation surfaces from language intrinsics to
     ordinary Gruel prelude fns. They no longer have normative
     entries in this section; the implementations live in
     `prelude/runtime_wrappers.gruel`. -->
