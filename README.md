...
- Several new primitives - `f16`/`f32`/`f64`, `isize`/`usize` (ADR-0046), and `char` (ADR-0071)
- Use of `usize` for indexing (ADR-0054)
- Tuples (ADR-0048)
- Slices (ADR-0064)
- Canonical `Option(T)`, `Clone` interface (ADR-0065), and `Result(T, E)` (ADR-0070)
- Vectors (ADR-0066)
...
- Tree-sitter implementation (ADR-0090)
- LSP implementation (ADR-0091)
