...
crate::define_for_all_platforms! {
    /// extern "C" fn __gruel_parse_i32(ptr: *const u8, len: u64) -> i32
...
define_for_all_platforms! {
    /// extern "C" fn __gruel_parse_i64(ptr: *const u8, len: u64) -> i64
...
define_for_all_platforms! {
    /// extern "C" fn __gruel_parse_u32(ptr: *const u8, len: u64) -> u32
...
define_for_all_platforms! {
    /// extern "C" fn __gruel_parse_u64(ptr: *const u8, len: u64) -> u64
