...
use lasso::Spur;
use rayon::prelude::*;
use gruel_builtins::{BuiltinReturnType, BuiltinTypeDef};
use gruel_error::{
...
fn try_evaluate_const_in_rir(rir: &gruel_rir::Rir, inst_ref: InstRef) -> Option<ConstValue> {
...
fn analyze_struct_init_ctx(
    ...
    use gruel_error::MissingFieldsError;
...
fn analyze_builtin_method_ctx(
    ...
    receiver_type: Type,
    builtin_method: &'static gruel_builtins::BuiltinMethod,
    args_start: u32,
    args_len: u32,
    span: Span,
    analysis_ctx: &mut AnalysisContext,
...
fn analyze_builtin_assoc_fn_ctx(
    ...
    air: &mut Air,
    struct_id: StructId,
    assoc_fn: &'static gruel_builtins::BuiltinAssociatedFn,
    args_start: u32,
    args_len: u32,
    span: Span,
    analysis_ctx: &mut AnalysisContext,
