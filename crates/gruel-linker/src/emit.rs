...
use crate::constants::{
    ...
    MACHO64_SEGMENT_CMD_SIZE, MACHO64_SYMTAB_CMD_SIZE, MH_MAGIC_64, MH_OBJECT, N_EXT, N_SECT,
    N_UNDF, PLATFORM_MACOS, R_AARCH64_ABS64, R_AARCH64_ADD_ABS_LO12_NC, R_AARCH64_ADR_PREL_PG_HI21,
    R_AARCH64_CALL26, R_AARCH64_JUMP26, R_X86_64_32, R_X86_64_32S, R_X86_64_64, R_X86_64_GOTPCREL,
...
impl ObjectBuilder {
    ...
    fn build_elf(self) -> Vec<u8> {
        ...
        for s in &self.strings {
            ...
            // No null terminator - Gruel strings are length-prefixed
        }
    ...
    fn build_macho(self) -> Vec<u8> {
        ...
        // e.g., "main" -> "_main", "__gruel_exit" -> "___gruel_exit"
