; Tree-sitter highlights for Gruel (ADR-0090 Phase 7).
;
; Capture names follow the conventional helix / nvim-treesitter / Zed
; vocabulary. Most editors will pick up the common ones (`@keyword`,
; `@function`, `@type`, etc.) without further configuration.
